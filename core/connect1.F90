...
!-----------------------------------------------------------------------
    ...
    do ie=1,nelv,2
        do iz=1,nz1,1
            if (iz == 1) write(6,106) txt10,iz,ie
            if (iz > 1) write(6,107)
            i1 = ie+1
            do j=ny1,1,-1
...
!-----------------------------------------------------------------------
    ...
    do ie=1,1
        ...
        do k=1,1
            ...
            write(6,117)
            do j=ny1,1,-1
                if (nx1 == 2) write(6,102) ((x(i,j,k,e+1),i=1,nx1),e=0,ne)
                if (nx1 == 3) write(6,103) ((x(i,j,k,e+1),i=1,nx1),e=0,ne)
                if (nx1 == 4) write(6,104) ((x(i,j,k,e+1),i=1,nx1),e=0,ne)
                if (nx1 == 5) write(6,105) ((x(i,j,k,e+1),i=1,nx1),e=0,ne)
                if (nx1 == 6) write(6,106) ((x(i,j,k,e+1),i=1,nx1),e=0,ne)
                if (nx1 == 7) write(6,107) ((x(i,j,k,e+1),i=1,nx1),e=0,ne)
                if (nx1 == 8) write(6,118) ((x(i,j,k,e+1),i=1,nx1),e=0,ne)
            enddo
        enddo
    enddo
...
!-----------------------------------------------------------------------
    ...
    do ie=ne1,1,-ne
        l=ie-1
        do k=1,1
            if (ie == ne1) write(m,116) txt10,k,ie,xmin,xmax,istep,time
            write(m,117)
            do j=ny1,1,-1
                if (nx1 == 2) write(m,102) ((x(i,j,k,e+l),i=1,nx1),e=1,ne)
                if (nx1 == 3) write(m,103) ((x(i,j,k,e+l),i=1,nx1),e=1,ne)
                if (nx1 == 4) write(m,104) ((x(i,j,k,e+l),i=1,nx1),e=1,ne)
                if (nx1 == 5) write(m,105) ((x(i,j,k,e+l),i=1,nx1),e=1,ne)
                if (nx1 == 6) write(m,106) ((x(i,j,k,e+l),i=1,nx1),e=1,ne)
                if (nx1 == 7) write(m,107) ((x(i,j,k,e+l),i=1,nx1),e=1,ne)
                if (nx1 == 8) write(m,108) ((x(i,j,k,e+l),i=1,nx1),e=1,ne)
            enddo
        enddo
    enddo
...
!-----------------------------------------------------------------------
    ...
    do ie=ne1,1,-ne
        l=ie-1
        do k=1,1
            if (ie == ne1) write(6,116) txt10,k,ie,xmin,xmax,istep,time
            write(6,117)
            do j=ny1,1,-1
                if (nx1 == 2) write(6,102) ((x(i,j,k,e+l),i=1,nx1),e=1,ne)
                if (nx1 == 3) write(6,103) ((x(i,j,k,e+l),i=1,nx1),e=1,ne)
                if (nx1 == 4) write(6,104) ((x(i,j,k,e+l),i=1,nx1),e=1,ne)
                if (nx1 == 5) write(6,105) ((x(i,j,k,e+l),i=1,nx1),e=1,ne)
                if (nx1 == 6) write(6,106) ((x(i,j,k,e+l),i=1,nx1),e=1,ne)
                if (nx1 == 7) write(6,107) ((x(i,j,k,e+l),i=1,nx1),e=1,ne)
                if (nx1 == 8) write(6,108) ((x(i,j,k,e+l),i=1,nx1),e=1,ne)
            enddo
        enddo
    enddo
...
!-----------------------------------------------------------------------
    ...
    do ie=ne1,1,-ne
        ...
        do k=1,1
            ...
            write(6,117)
            do j=ny2,1,-1
                if (nx2 == 2) write(6,102) ((x(i,j,k,e+l),i=1,nx2),e=1,ne)
                if (nx2 == 3) write(6,103) ((x(i,j,k,e+l),i=1,nx2),e=1,ne)
                if (nx2 == 4) write(6,104) ((x(i,j,k,e+l),i=1,nx2),e=1,ne)
                if (nx2 == 5) write(6,105) ((x(i,j,k,e+l),i=1,nx2),e=1,ne)
                if (nx2 == 6) write(6,106) ((x(i,j,k,e+l),i=1,nx2),e=1,ne)
                if (nx2 == 7) write(6,107) ((x(i,j,k,e+l),i=1,nx2),e=1,ne)
                if (nx2 == 8) write(6,108) ((x(i,j,k,e+l),i=1,nx2),e=1,ne)
            enddo
        enddo
    enddo
...
!-----------------------------------------------------------------------
    ...
    do ie=ne1,1,-ne
        ...
        do k=1,1
            ...
            write(6,117)
            do j=ny2,1,-1
                if (nx2 == 2) write(m,102) ((x(i,j,k,e+l),i=1,nx2),e=1,ne)
                if (nx2 == 3) write(m,103) ((x(i,j,k,e+l),i=1,nx2),e=1,ne)
                if (nx2 == 4) write(m,104) ((x(i,j,k,e+l),i=1,nx2),e=1,ne)
                if (nx2 == 5) write(m,105) ((x(i,j,k,e+l),i=1,nx2),e=1,ne)
                if (nx2 == 6) write(m,106) ((x(i,j,k,e+l),i=1,nx2),e=1,ne)
                if (nx2 == 7) write(m,107) ((x(i,j,k,e+l),i=1,nx2),e=1,ne)
                if (nx2 == 8) write(m,108) ((x(i,j,k,e+l),i=1,nx2),e=1,ne)
            enddo
        enddo
    enddo
...
!-----------------------------------------------------------------------
    ...
    do ipass = 1,2
        iquick = 0
        if (nid == 0) iquick=glo_num(ipass,1,1,1)
        ...
        do e=1,nelv
            do k=1,nz1
                do j=1,ny1
                    do i=1,nx1
                        if (glo_num(i,j,k,e) == iquick) then
                            eg = lglel(e)
...
!     Process data
    ...
    do mid=0,np-1
        call nekgsync()
        if (mid == nid) write(6,1) nid,n2,no
...
!-----------------------------------------------------------------------
    ...
    do ipass = 1,2
        ...
        if (ipass == 1) then  ! set up pairwise-only handle
            do i=1,n
                if (c(i) == 0 .OR. c(i) > 1) x(i) = 0
            enddo
    ...
    if (nid == 0) write(6,1) t1,t2,t3,t4,t5
    1 format(5e12.4,' dstatb')

    return
    end subroutine gs_new_tstr
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
    ...
    do e=1,nel
        do f=1,nface
            if (cbc(f,e,1) == 'msi' .OR. cbc(f,e,1) == 'MSI') iflag=1
        enddo
    enddo
...
!     We need to differentiate elements according to unit normal on msi face.

!     NOTE that this code assumes we do not have two adjacent faces on a given
!     element that both have cbc = msi!
    ...
    do e=1,nel
        ...
        do f=1,nface
            if (cbc(f,e,1) == 'msi' .OR. cbc(f,e,1) == 'MSI') then
                ...
                do i=1,nxz
                    jg = efc(i)+0.1
                    if (jg == eg) then         ! this is the controlling face
                        snx(i) = unx(i,1,f,e)
                        sny(i) = uny(i,1,f,e)
                        snz(i) = unz(i,1,f,e)
                    endif
...
!     Now, check to see if normal is aligned with incoming normal
        ...
        do k=1,nz1,nsz
            do j=1,ny1,nsy
                do i=1,nx1,nsx
                    ...
                    if (dot < -.5) jvrtex(l,e)=jvrtex(l,e)+mvertx
                enddo
            enddo
        enddo
    enddo
