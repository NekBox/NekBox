subroutine mxm_bgq_8(a,n1,b,n2,c,n3)
  ...
  integer :: i, j
  vector(real(DP)) av1, av2, av3, av4, av5, av6, av7, av8
  vector(real(DP)) bv1, bsv1, bsv2, bsv3, bsv4
  vector(real(DP)) bv2, bsv5, bsv6, bsv7, bsv8
  vector(real(DP)) cv
...
subroutine mxm_bgq_12(a,n1,b,n2,c,n3)
  ...
  vector(real(DP)) av1, av2, av3, av4, av5, av6, av7, av8
  vector(real(DP)) av9, av10, av11, av12
  vector(real(DP)) bv1, bsv1, bsv2, bsv3, bsv4
  vector(real(DP)) bv2, bsv5, bsv6, bsv7, bsv8
  vector(real(DP)) bv3, bsv9, bsv10, bsv11, bsv12
...
subroutine mxm_bgq_16(a,n1,b,n2,c,n3)
  ...
  vector(real(DP)) av1, av2, av3, av4, av5, av6, av7, av8
  vector(real(DP)) av9, av10, av11, av12, av13, av14, av15, av16
  vector(real(DP)) bv1, bsv1, bsv2, bsv3, bsv4
  vector(real(DP)) bv2, bsv5, bsv6, bsv7, bsv8
  vector(real(DP)) bv3, bsv9, bsv10, bsv11, bsv12
  vector(real(DP)) bv4, bsv13, bsv14, bsv15, bsv16
...
subroutine mxm_bgq_6(a,n1,b,n2,c,n3)
  ...
  vector(real(DP)) av1, av2, av3, av4, av5, av6
  vector(real(DP)) bv1, bsv1, bsv2, bsv3, bsv4
  vector(real(DP)) bv2, bsv5, bsv6
...
subroutine mxm_bgq_10(a,n1,b,n2,c,n3)
  ...
  vector(real(DP)) av1, av2, av3, av4, av5, av6, av7, av8
  vector(real(DP)) av9, av10
  vector(real(DP)) bv1, bsv1, bsv2, bsv3, bsv4
  vector(real(DP)) bv2, bsv5, bsv6, bsv7, bsv8
  vector(real(DP)) bv3, bsv9, bsv10
  vector(real(DP)) cv
