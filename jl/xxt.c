...
#define crs_setup PREFIXED_NAME(crs_setup_xxt)
#define crs_solve PREFIXED_NAME(crs_solve_xxt)
#define crs_stats PREFIXED_NAME(crs_stats_xxt)
#define crs_free  PREFIXED_NAME(crs_free_xxt )
