...
! pack input data
    n = 0
    do i = 1,ntot
        if(bmask(i) == 1) then  ! is this point active?
            n = n + 1
            lb_imap(n) = i
            do j = 1,m
                k = (j-1)*ltot + i
