...
!     of a function FNC known to lie between X1 and X2.  The root,
...
!      WRITE(21,*) 'Exceeding maximum number of iterations.'
    ZBRENT=B
    return
    END FUNCTION ZBRENT
    FUNCTION FNC(ETA)
